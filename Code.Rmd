...
```
Setting all labels to -1, the accuracy for test data is 0.895 and that for validation data is 0.435, which are relatively low. If the test data and validation data contain mostly -1, the trivial classifier will have a high average accuracy.
